...
::: danger These changes are breaking or changing existing behavior from Docker Compose v1 and *requires* your attention and possibly some work to fix.
:::
...
Going forward we will automatically build and push Docker images for Pixelfed to both [Docker Hub](https://hub.docker.com/r/pixelfed/pixelfed) and [GitHub Container Registry](https://github.com/pixelfed/pixelfed/pkgs/container/pixelfed).
