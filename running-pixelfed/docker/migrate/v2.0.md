...
There is a *lot* of changes and improvements being delivered in the version 2 iteration
...
::: tip
Please see the [Migration steps](#migration-steps) section for information on moving your data.
:::
...
### Disable "One-time setup tasks" auto running <Badge type="warning" text="Attention needed" />
